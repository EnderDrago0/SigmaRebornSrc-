...
public class GuiDisconnected extends GuiScreen
{
    ...
    private com.mentalfrostbyte.jello.login.AltLoginThread thread;
    ...
    {
    	if(button.id == 4) {
    		ServerData dat = new ServerData("", sip);
        ...
        if (button.id == 2)
        {
        	this.thread = new com.mentalfrostbyte.jello.login.AltLoginThread("SJR" + Minecraft.getSystemTime() % 1000L, "");
        	thread.start();
