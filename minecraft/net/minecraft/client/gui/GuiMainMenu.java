...
import com.mentalfrostbyte.jello.discord.Client;
import com.mentalfrostbyte.jello.discord.DiscordRP;
import com.mentalfrostbyte.jello.login.GuiAltLogin;
import com.mentalfrostbyte.jello.main.Jello;
import com.mentalfrostbyte.jello.particles.ParticleEngine;
import com.mentalfrostbyte.jello.util.FontUtil;
import com.mentalfrostbyte.jello.util.WinRegistry;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public float zoom1 = 1, zoom2 = 1, zoom3 = 1, zoom4 = 1, zoom5 = 1, updateNee;
    ...
    public void initGui()
    {
    	//Client.discordRP.update("Idle", "Main Menu");
    	DiscordRP.update("Idle", "Main Menu");
    	pe.particles.clear();
    ...
    {
    	this.buttonList.add(new GuiButton(69, 5, 5, 160, 20, "Version Selector Coming Soon"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("Jello/mainmenu.png"));//this.mc.getTextureManager().bindTexture(new ResourceLocation("Jello/mainmenubg.png"));
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        if(Jello.updateNeeded) {
   		 	FontUtil.jelloFont.drawNoBSString("A new update is available, click here to download", 5 + updateNee, sr.getScaledHeight() - 20 - FontUtil.jelloFont.getHeight() + 1, -1);
   	    }
        FontUtil.jelloFont.drawNoBSString("© Jello by Mentalfrostbyte. Reborn by Cancelled#2089", 5, sr.getScaledHeight() - 5 - FontUtil.jelloFont.getHeight() + 1, -1);
        
        FontUtil.jelloFont.drawNoBSString("Minecraft 1.8.8 / Jello " + Jello.version, sr.getScaledWidth() - 5 - 0.5f - FontUtil.jelloFont.getStringWidth("Minecraft 1.8.8 / Jello 1.2.1") + 1, sr.getScaledHeight() - 5 - FontUtil.jelloFont.getHeight() + 1, -1);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        if(mouseButton == 0){
            ...
            if(this.isMouseHoveringRect1(offset + 4, height + 4, 64-8, 64-8, mouseX, mouseY)){
            	...
            	/*
        		try {
        		WinRegistry.createKey(WinRegistry.HKEY_CURRENT_USER, "SJRConfigFile");
        		//WinRegistry.createKey(0x00000000, "");
        			
        			
        		//WinRegistry.createKey(WinRegistry.HKEY_CURRENT_USER, "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\FileExts\\.trole");
        	//	WinRegistry.createKey(WinRegistry.HKEY_CURRENT_USER, "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\FileExts\\.trole\\OpenWithList");
        	//	WinRegistry.createKey(WinRegistry.HKEY_CURRENT_USER, "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\FileExts\\.trole\\OpenWithProgids");
        	//	WinRegistry.writeStringValue(WinRegistry.HKEY_CURRENT_USER, "SOFTWARE\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Explorer\\\\FileExts\\\\.trole", field_146972_A, field_104024_v);
        		//WinRegistry.writeStringValue(mouseButton, field_92025_p, field_146972_A, field_104024_v);
            ...
            offset += 122/2f;
            if(Jello.updateNeeded && this.isMouseHoveringRect1(5 + updateNee, sr.getScaledHeight() - 20 - FontUtil.jelloFont.getHeight() + 1, (float) FontUtil.jelloFont.getStringWidth("A new update is available, click here to download"), FontUtil.jelloFont.getHeight() + 3, mouseX, mouseY)){
            	try {
	            	URI u = new URI("https://jellosigma.github.io/JelloReborn/");
