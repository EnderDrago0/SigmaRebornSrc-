...
import com.mentalfrostbyte.jello.modules.AntiBot;
import com.mentalfrostbyte.jello.modules.ESP;
...
public abstract class RendererLivingEntity extends Render
{
    ...
    {
    	EventRenderEntity event = new EventRenderEntity(p_76986_1_);
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_)}))
        {
            ...
            try
            {
                ...
                if(p_76986_1_ == renderManager.livingPlayer)
                	var201 = p_76986_1_.prevRenderPitchRotation + (p_76986_1_.renderPitchRotation - p_76986_1_.prevRenderPitchRotation) * p_76986_9_;//var201 = p_76986_1_.prevrotationPitchHead + (p_76986_1_.prevrotationPitchHead - p_76986_1_.prevrotationPitchHead) * p_76986_9_;
                else
                ...
                else
                {
                    ...
                    boolean valid = p_76986_1_ instanceof EntityMob || p_76986_1_ instanceof EntityIronGolem ||
                    		p_76986_1_ instanceof EntityAnimal || p_76986_1_ instanceof EntityVillager || p_76986_1_ instanceof EntityPlayer;
                    if(valid){
                    	boolean esp = Jello.getModule("ESP").isToggled();
                		String mode = ESP.mode.getMode();
                	   	if(esp && (mode.equalsIgnoreCase("CSGO") || mode.equalsIgnoreCase("Fill"))){
                        	if(ESP.isValid(p_76986_1_)){
                           		Minecraft mc = Minecraft.getMinecraft();
                        		String colorMode =  ESP.colormode.getMode();
                        		int renderColor = 0xff4260f5;
                        		switch(colorMode){
         	                    case"Rainbow":{
         	                    ...
         	                    break;
         	                    case"Team":{
         	                    String text = p_76986_1_.getDisplayName().getFormattedText();
         	                    ...
         	                    break;
         	                    case"Custom":
         	                    	renderColor = 0xff4260f5;
         	                    	break;
         	                    }        
         	                    if(p_76986_1_.hurtResistantTime > 15 && colorMode.equalsIgnoreCase("Fill")){
         	                    	renderColor = ColorUtil.getColor(1, 0, 0, 1);
         	                    }
         	                    if(AntiBot.bot.contains(p_76986_1_)){
         	                ...
         	                //    }                     
                                ...
                                if(p_76986_1_ == mc.thePlayer)
                                	this.renderModel(p_76986_1_, var17, var16, var14, var12, p_76986_1_.prevRenderPitchRotation + (p_76986_1_.renderPitchRotation - p_76986_1_.prevRenderPitchRotation) * p_76986_9_, 0.0625F);
                                else
                                	this.renderModel(p_76986_1_, var17, var16, var14, var12, p_76986_1_.prevRotationPitch + (p_76986_1_.rotationPitch - p_76986_1_.prevRotationPitch) * p_76986_9_, 0.0625F);
