...
public class LayerCape implements LayerRenderer
{
    ...
    {
        if (p_177166_1_.hasCape() && p_177166_1_.func_175148_a(EnumPlayerModelParts.CAPE))
        {
        	if(p_177166_1_.getName().equalsIgnoreCase(Minecraft.getMinecraft().getSession().getUsername())) {
	            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
	            this.playerRenderer.bindTexture(new ResourceLocation("Jello/capes/cape.png"));
	            ...
	            if (p_177166_1_ instanceof EntityPlayerSP) {
	                if (true) {
	                    var15 = MathUtil.interpolate(p_177166_1_.prevRotationYaw, p_177166_1_.rotationYaw, p_177166_4_);
	                }
	            }
	            ...
	            GlStateManager.rotate(var22 / 2.0F, 0.0F, 0.0F, 1.0F);// GlStateManager.rotate(var22 / 2.0F + Minecraft.getMinecraft().getSystemTime(), 0.0F, 0.0F, 1.0F);
