...
import com.mentalfrostbyte.jello.modules.Animations;
...
public class ItemRenderer
{
    ...
    private void sigma(float equipProgress, float swingProgress)
    {//sigma
    	GlStateManager.translate(0.86F, -0.72F, -0.71999997F);
    ...
    private void exhi(float equipProgress, float swingProgress)
    {//exhibition
    	GlStateManager.translate(0.56F, -0.32F, -0.71999997F);
        GlStateManager.translate(0.0F, equipProgress * -0.3F, 0.0F);
        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
        GlStateManager.rotate(f * -20.0F, 0.0F, 1.0F, 0.0F);
    ...
    public void renderItemInFirstPerson(float p_78440_1_)
    {
        ...
        final float f6 = MathHelper.sin((float)(MathHelper.sqrt_float(var4) * 3.1));
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (var3.getItemInUseCount() > 0|| (KillAura.blocking && mc.thePlayer.getHeldItem() != null && mc.thePlayer.getHeldItem().getItem() instanceof ItemSword))
            {
                ...
                switch (ItemRenderer.SwitchEnumAction.field_178094_a[var7.ordinal()])
                {
                    ...
                    case 4:
                    	if(Animations.en && Animations.mode.is("Jello")) {
	                       ...
	                       // GlStateManager.translate(0, 0, 0.5);
	                        ...
	                        break;
                    	}else if(Animations.en && Animations.mode.is("Exhibition")) {
                    		this.exhi(var2 / 2.0F, 0.0F);
	                        GL11.glRotatef(-var9 * 40.0F / 2.0F, var9 / 2.0F, -0.0F, 9.0F);
	                        GL11.glRotatef(-var9 * 30.0F, 1.0F, var9 / 2.0F, -0.0F);
	                        this.func_178103_d();
	                        break;
                    	}else if(Animations.en && Animations.mode.is("Slide")) {
                            ...
                            float f8 = MathHelper.sin(var4 * var4 / 64 * (float) Math.PI);
                            float f9 = MathHelper.sin(MathHelper.sqrt_float(var4) * (float) Math.PI);
	                        ...
	                        break;
                    	}else if(Animations.en && Animations.mode.is("OldSigma")) {
                    		this.sigma(var2 * 0.0f, -2.0f);
                            GlStateManager.rotate(f6 * 10.0f, -1.0f, 9.0f, 0.0f);
                            GlStateManager.rotate(f6 * 10f, 0f, 0f, 1f);
                            GlStateManager.rotate(f6 * 20	, f6 * -20f,f6 * -10f, 1f);
                            ...
                            break;
                    	}else if(Animations.en && Animations.mode.is("Leaked")) {
                    		this.sigma(var2 * 0.0f, -2.0f);
                            GlStateManager.rotate(f6 * 10.0f, -1.0f, 9.0f, 0.0f);
                            GlStateManager.rotate(f6 * 30.0f, 0f, 0f, 1f);
                            ...
                            GlStateManager.scale(1.4, 1.4, 1.4);
                            break;
                    	}else if(Animations.en && Animations.mode.is("Exhibition2")) {
...
//                          this.func_178103_d();
                          ...
                          break;
                    	}else if(Animations.en && Animations.mode.is("Slide2")) {
                            this.func_178096_b(var2, 0.0f);
                            this.func_178103_d();
                            ...
                            break;
                    	}else if(Animations.en && Animations.mode.is("Swang")) {
                		    this.func_178096_b(var2 / 2.0F - 0.2f, var4);
                            float var152 = MathHelper.sin((float) (MathHelper.sqrt_float(var2) * Math.PI));
