...
public class EntityFX extends Entity
{
    ...
    public EntityFX(World worldIn, double p_i1219_2_, double p_i1219_4_, double p_i1219_6_, double p_i1219_8_, double p_i1219_10_, double p_i1219_12_)
    {
        ...
        this.motionX = p_i1219_8_ + (Math.random() * 1.0D - 1.0D) * 0.4000000059604645D;
        this.motionY = p_i1219_10_ + (Math.random() * 1.0D - 1.0D) * 0.4000000059604645D;
        this.motionZ = p_i1219_12_ + (Math.random() * 1.0D - 1.0D) * 0.4000000059604645D;
        ...
        this.motionX = this.motionX / (double)var15 * (double)var14 * 1.4000000059604645D;
        this.motionY = this.motionY / (double)var15 * (double)var14 * 1.4000000059604645D + 0.10000000149011612D;
        this.motionZ = this.motionZ / (double)var15 * (double)var14 * 1.4000000059604645D;
    }
