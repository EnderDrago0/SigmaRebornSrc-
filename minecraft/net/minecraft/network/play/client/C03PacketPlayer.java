...
public class C03PacketPlayer implements Packet
{
    ...
    {
        this.ground = data.readUnsignedByte() != 0;
    }
    ...
    {
        data.writeByte(this.ground ? 1 : 0);
    }
