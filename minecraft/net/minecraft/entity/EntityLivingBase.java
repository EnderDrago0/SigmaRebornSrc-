...
public abstract class EntityLivingBase extends Entity
{
    ...
    public EntityLivingBase(World worldIn)
    {
        ...
        this.rotationPitch = (float)(Math.random() * Math.PI * 2.0D);
    ...
    {
        return (this.isPotionActive(Potion.digSpeed) ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier()) * 1 : (this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6) * Minecraft.getMinecraft().timer.timerSpeed);
    }
    ...
    {
        float var1 = this.getArmSwingAnimationEnd();
    ...
    protected void jump()
    {
        ...
        if (this.isSprinting())
        {//idk what i did, skidded form rise
        	 float f = this.rotationYaw * 0.017453292F;
        	final Minecraft mc = Minecraft.getMinecraft();
        	if (Sprint.multi.isEnabled()) {
                if (mc.gameSettings.keyBindForward.getIsKeyPressed()) f = mc.thePlayer.rotationYaw;
                else if (mc.gameSettings.keyBindLeft.getIsKeyPressed()) f = mc.thePlayer.rotationYaw - 90;
                else if (mc.gameSettings.keyBindRight.getIsKeyPressed()) f = mc.thePlayer.rotationYaw + 90;
                else if (mc.gameSettings.keyBindBack.getIsKeyPressed()) f = mc.thePlayer.rotationYaw - 180;
