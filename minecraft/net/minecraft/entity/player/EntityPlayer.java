...
import com.mentalfrostbyte.jello.modules.Fly;
...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (!(this.onGround || AirWalk.isEnabled || Fly.e) || this.getHealth() <= 0.0F)
        {
            var2 = 0.0F;
        }
    ...
    public float getEyeHeight()
    {
        ...
        if(!custom) {
            ...
            var1 = (float) (1.62F - (mc.thePlayer.lastTickPosY + (((mc.thePlayer.posY - mc.thePlayer.lastTickPosY) * mc.timer.renderPartialTicks)) - customY));
        	return var1;
        }
    }
    ...
    public static void useCustomY(boolean yesorno) {
    	custom = yesorno;
    }
