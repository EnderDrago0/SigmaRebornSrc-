...
import com.mentalfrostbyte.jello.event.events.StrafeEvent;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double var15 = y;
            double var17 = z;
            boolean var19 = this.onGround && ((BlockFly.safewalk && BlockFly.safeWalk.isEnabled())? true:this.isSneaking()) && this instanceof EntityPlayer;//boolean var19 = this.onGround && ((BlockFly.ena)? true:this.isSneaking()) && this instanceof EntityPlayer;
...
//        strafe = strafeEvent.getStrafe();
        ...
        if (var4 >= 1.0E-4F)
        {
            ...
            if (this == mc.thePlayer) {
                if (EntityPlayer.movementYaw != null) {
                    var5 = MathHelper.sin(EntityPlayer.movementYaw * (float) Math.PI / 180.0F);
                    var6 = MathHelper.cos(EntityPlayer.movementYaw * (float) Math.PI / 180.0F);
                }
            }
    ...
    public final Vec3 func_174806_f(final float p_174806_1_, final float p_174806_2_)
    {
    ...
    public final Vec3 getVectorForRotationFloat(final float p_174806_1_, final float p_174806_2_)
    {
        float var3 = MathHelper.cos(-p_174806_2_ * 0.017453292F - (float)Math.PI);
        float var4 = MathHelper.sin(-p_174806_2_ * 0.017453292F - (float)Math.PI);
        float var5 = -MathHelper.cos(-p_174806_1_ * 0.017453292F);
